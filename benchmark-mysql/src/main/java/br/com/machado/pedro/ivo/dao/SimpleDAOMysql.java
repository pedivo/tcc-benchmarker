 ...
 */
public class SimpleDAOMySql extends SimpleDAO {
		...
		private static final String     DB_URL = "jdbc:mysql://172.16.83.4:3307/BENCHMARKER?useUnicode=true&characterEncoding=UTF-8";
		private static final String     DB_URL_NO_SCHEMA = "jdbc:mysql://172.16.83.4:3307/";
		private static final Logger     LOGGER = LoggerFactory.getLogger(SimpleDAOMySql.class);

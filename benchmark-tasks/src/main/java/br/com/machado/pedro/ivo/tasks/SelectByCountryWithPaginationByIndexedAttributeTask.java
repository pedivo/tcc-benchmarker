 ...
 * 
 */
public class SelectByCountryWithPaginationByIndexedAttributeTask implements Command {
	...
	public SelectByCountryWithPaginationByIndexedAttributeTask(Long total, Country country) {
		this.total = total;
	...
	public void execute() {
		int offset = 0;
		while (offset <= total) {
			Long totalTime = DAOFactory.createSimpleDAO().selectByIndexedCountry(country, offset, pagesize);

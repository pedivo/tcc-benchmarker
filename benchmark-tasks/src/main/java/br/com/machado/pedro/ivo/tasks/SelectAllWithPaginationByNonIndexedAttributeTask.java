 ...
 * @author Pedro
 */
public class SelectAllWithPaginationByNonIndexedAttributeTask implements Command {
		...
		public SelectAllWithPaginationByNonIndexedAttributeTask(Long total, Country country) {
				this.total = total;
